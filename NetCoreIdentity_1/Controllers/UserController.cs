    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateUserRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                IdentityResult result = await _userManager.CreateAsync(appUser, $"{model.UserName}eko123");
                if (result.Succeeded)
                {
        ...
        public async Task<IActionResult> AssignRole(int id)
        {
            ...
            List<AppRoleResponceModel> roles = new();
        ...
        public async Task<IActionResult> AssignRole(AssignRolePageVM model)
        {
            ...
            foreach (AppRoleResponceModel role in model.Roles)
            {
